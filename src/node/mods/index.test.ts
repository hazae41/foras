...
import { deflate, DeflateDecoder, DeflateEncoder, gunzip, GzDecoder, GzEncoder, gzip, inflate, initBundledOnce, unzlib, zlib, ZlibDecoder, ZlibEncoder } from "./index.js";
