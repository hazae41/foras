...
export function deflate(input, compression) {
    ...
    wasm.deflate(8, ptr0, len0, !isLikeNone(compression), isLikeNone(compression) ? 0 : compression);
...
export function gzip(input, compression) {
    var ptr0 = passArray8ToWasm0(input, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    wasm.gzip(8, ptr0, len0, !isLikeNone(compression), isLikeNone(compression) ? 0 : compression);
    var r0 = getInt32Memory0()[8 / 4 + 0];
    var r1 = getInt32Memory0()[8 / 4 + 1];
    var v1 = getArrayU8FromWasm0(r0, r1).slice();
    wasm.__wbindgen_free(r0, r1 * 1);
...
export function zlib(input, compression) {
    var ptr0 = passArray8ToWasm0(input, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    wasm.zlib(8, ptr0, len0, !isLikeNone(compression), isLikeNone(compression) ? 0 : compression);
    var r0 = getInt32Memory0()[8 / 4 + 0];
    var r1 = getInt32Memory0()[8 / 4 + 1];
    var v1 = getArrayU8FromWasm0(r0, r1).slice();
    wasm.__wbindgen_free(r0, r1 * 1);
