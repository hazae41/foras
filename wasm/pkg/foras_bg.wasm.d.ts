...
export function gunzip(a: number, b: number): void;
export function __wbg_gzdecoder_free(a: number): void;
export function gzdecoder_new(): number;
export function gzdecoder_write(a: number, b: number, c: number): void;
...
export function gzdecoder_read(a: number): number;
export function zlibencoder_read(a: number): number;
export function deflateencoder_read(a: number): number;
export function zlibdecoder_read(a: number): number;
export function __wbg_zlibdecoder_free(a: number): void;
export function zlibencoder_write(a: number, b: number, c: number): void;
export function zlibdecoder_write(a: number, b: number, c: number): void;
